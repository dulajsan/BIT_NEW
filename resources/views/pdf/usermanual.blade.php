...
<ol>
	...
	<ol>
		...
		<p>Enter your private details here.</p>
		<ol>
			<li><b><u>1.1.a. Full Name</u></b></li>
			<p>Click on the blank box in front of the label ‘Full Name’ and type your full name (not the name with initials) in  the box as depicted below.</p>
			...
			<p> Eg: Madurasinghege Dulaj Sanjaya</p>
			<p> M.D.Sanjaya </p>
			...
			<li><b><u>1.1.d. Title</u></b></li>
				...
				<p>Then the list would disappear and your selected title would appear in the title box.</p>
				<p>		Eg:-    For Priyankara title would be Mr. </p>
                <p>If you are a priest the title would be Ven.</p>
                <p>If you want to change your selection you can repeat from 1.1.a.</p>
			...
			<li><b><u>1.1.f. Citizenship</u></b></li>
				...
				<p>You have two options; Sri Lankan or Foreign.</p>
				<p>If you want to change your selection you can repeat from 1.1.f.</p>

			<li><b><u>1.1.g. Nic/ Passport</u></b></li>
				<p>You can enter either National Identity Card No. or Passport No.</p>
				<p>Select the circle in front of NIC if you wish to provide your NIC number.</p>
				<p>After you select it another blank will appear below to enter your NIC number and be aware to provide it in the following format.</p>
				<p>        93********V / 93********X</p>
				<p>Or</p>
				<p>Select the circle in front of Passport if you wish to provide your Passport number.</p>
				<p>After you select it another blank will appear below to enter your Passport number and be aware to provide it in the following format.</p>
		...
		<p>Now you are in the second step of the Registration process. Enter your required contact details here.</p>
					<ol>
				<li><b><u>1.2.a. Permanent Address</u></b></li>
					<p>	Fill your home address (the address you can receive the letters) as in the format in the example.</p>
					<p>		In address line one  - the number</p>
					<p>		In address line two  - the road name</p>
					<p>		In address line three- the city name</p>
				<li><b><u>1.2.b. Country Name</u></b></li>
					<p>Choose the country from the drop down list.</p>
					<p>Click the sign in the right corner of the label and Select the country you belong. Place your mouse pointer on the relevant country name so that it would be highlighted, then click or press the Enter button.</p>
					<p>Then the list would disappear and your selected country would appear in the title box </p>
				<li><b><u>1.2.c. Email</u></b></li>
					<p>Enter your valid email address in the correct format as below.</p>
					<p>cchandima2010@gmail.com</p>
		...
		<li><b><u>1.3.Educational Details</u></b></li>
		<p>Now you are in the third step of the Registration process. Enter your required educational details.</p>
			<ol>
